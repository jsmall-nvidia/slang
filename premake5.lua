...
cppExtractorConfigFile = io.open("cpp-extractor.config", "w")
    
cppExtractorConfigFile:write("# DO NOT EDIT. This file is generated by the premake5.lua file!\n")
cppExtractorConfigFile:write("\n")
...
standardProject "slang"
    ...
    do 
        ...
        local buildArgs = " -d " .. sourcePath .. " " .. table.concat(inputFiles, " ") .. " -strip-prefix slang-ast- -o slang-ast-generated"
        
        -- Write the build line to the extractor file
        cppExtractorConfigFile:write("slang-cpp-extractor " .. buildArgs .. "\n")

        if executeBinary then    
            buildmessage "slang-cpp-extractor AST"

            buildcommands { '"%{cfg.targetdir}/slang-cpp-extractor"' .. buildArgs }
